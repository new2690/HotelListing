        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    UserId = table.Column<int>(type: "int", nullable: false),
                    RoleId = table.Column<int>(type: "int", nullable: false),
                    ApiRoleId = table.Column<int>(type: "int", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AspNetUserRoles_AspNetUsers_ApiUserId",
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "0e921a83-a289-4099-83c4-acd1e6a40e55", "User", "USER" },
                    { 2, "e65f4664-7054-4987-9fc6-ad4bea32aa36", "Administrator", "ADMINISTRATOR" }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AspNetUserRoles_ApiUserId",
                table: "AspNetUserRoles",
                column: "ApiUserId");
